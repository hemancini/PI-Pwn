...
if (isset($_POST['restart'])) {
    exec('sudo systemctl restart pipwn');
    exec('echo "\033[32mRestarting...\033[0m" | sudo tee /dev/tty1 | sudo tee /dev/pts/* | sudo tee -a /boot/firmware/PPPwn/pwn.log');
}
